	...
	switch(passenger_type) 
		{
		   case ADULT:
		   {
		     	addRequest(init_pass(ADULT_LOAD,start_floor,destination_floor));
		      break;
		   }

		   case CHILD:
		   {
		      addRequest(init_pass(CHILD_LOAD,start_floor,destination_floor));
		      break;
		   }

		   case RSERVICE:
		   {
		      addRequest( init_pass(RSERVICE_LOAD,start_floor,destination_floor));
		      break;
		   }

		  	case BELLHOP:
		  	{
		      addRequest(init_pass(BELLHOP_LOAD,start_floor,destination_floor));
		      break;
		    }
